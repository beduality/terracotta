...
- Ensure the relevant `CHANGELOG.md` files have user-facing changes under `## [Unreleased]`. Module-specific changes go in `modules/<module>/CHANGELOG.md`; repo-wide changes go in the root `CHANGELOG.md`. See [Writing Changelog Entries](../how-to-guides/writing-changelog.md).
