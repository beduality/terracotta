...
- Add support to load any Terracotta config value from file just using `<field>File` convention, e.g. `descriptionFile`
- Add [Import Task](./proposals/2026-07-import-task.md)
- Stabilize gallery item identity via persisted state
- Add [GitHub provider](./proposals/2025-07-github-provider.md)
