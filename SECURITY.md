...
At Terracotta, the security of your data and the integrity of our tool are absolute priorities. We are deeply committed to protecting your information and providing a secure online environment for the community.
...
If you discover a security vulnerability in any part of the Terracotta project, please **do not create a public issue**. Instead, **report it immediately** to the email [luisfuturist+terracotta.security@gmail.com](mailto:luisfuturist+terracotta.security@gmail.com).
...
We value the contributions of the security community to keep Terracotta secure. All legitimate reports will be thoroughly investigated and addressed with appropriate urgency.

## 2. Supported Versions

To ensure maximum security, only the **latest production version** of Terracotta is officially supported and receives continuous security updates.

* **Preview and Older Versions**: Snapshot versions and versions older than the latest production release may contain known vulnerabilities and are not actively maintained for security purposes. We will try our best to support them, but we cannot guarantee it. We encourage you to update to the latest version.
